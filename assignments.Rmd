...
1. Choose a suitable dataset, and describe the data.
   - You can use any of the 6 datasets linked [below](#data_options).
1. State the research question; define and explicate the theoretical path model.
...
1. Choose a suitable dataset, and describe the data.
   ...
   - If you want to switch, you can use any of the 6 datasets linked [below](#data_options).
1. State the research question; define and explicate the theoretical CFA model.
...
1. Choose a suitable dataset, and describe the data.
   - Ideally, you will work with the same data that you analyzed in Assignments 
     1 & 2.
   - If you want to switch, you can use any of the 6 datasets linked [below](#data_options).
1. State the research question; define and explicate the theoretical SEM. 
    a. The structural component of this model must include, at least, three
    variables.
    a. The model must include, at least, two latent variables.
    a. Use a path diagram to represent your model.
...
Assignments 1 & 2 are simply graded as pass/fail. To pass, your assignment must:
...
Assignment 3 will be fully graded using the indicated rubric.
