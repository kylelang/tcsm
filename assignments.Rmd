...
2. You will report your analysis by filling in a structured worksheet. You can 
download the worksheet below (in various formats).

- [R Markdown](data/a2_template.Rmd)
- [Quarto](data/a2_template.qmd)
- [MS Word](data/a2_template.docx)
...
Assignment 3 is due at 23:59 on Wednesday 6 November 2024.
...
1. Make a reasonable effort to complete all required work
   - Include the XX required components in your A1 report
   - Complete every section of the A2 worksheet
1. Demonstrate a basically sound ability to apply path analysis/CFA
   - Your work must demonstrate that you know what you're doing and are not just mindlessly implementing a sequence of memorized actions. 
...
- Your revised grad for A3 cannot be higher than 6.
