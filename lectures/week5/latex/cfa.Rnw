...
\begin{frame}{Reflective Constructs}
  ...
  The true temperature is the causal factor that produces thermometer readings.
  \begin{itemize}
    \item Any given thermometer reading is only an imperfect reflection of the true temperature.
    \item Taking multiple readings increases the reliability of our temperature estimate.
  \end{itemize}
...
\begin{frame}{Formative Constructs}
  ...
  In a formative measurement model, the direction of the factor loadings is flipped.
...
\subsection{Under-Identifed Models}
...
\begin{frame}{Under-Identifed: Marker-Variable}
...
\begin{frame}{Under-Identifed: Fixed-Factor}
...
\begin{frame}{Over-Identified Models}
  ...
  \begin{columns}
    \begin{column}{0.5\textwidth}
      ...
      With 4 indicaotrs, our model contains 14 parameters:
      \begin{itemize}
