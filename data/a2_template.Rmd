...
- Be concise.
   ...
   - You won't get any extra credit for extraneous information.
   - Waffling will hurt your grade.
- Replace the placeholder values in the front matter with your Assignment 2
  Group's details and the appropriate date.
- Submit your completed worksheet as a PDF document.
   - Any other file format will hurt your grade.
...
- *Why is your factor $\rightarrow$ item mapping justified?*
...
- *Again, `lavInspect()` is your friend.*

```{r, echo = FALSE}

```

## Report a suitable set of model fit indices for your estimated model. [3]
