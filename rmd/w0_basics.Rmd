...
```{block, type = 'rmdinfo'}
This optional chapter will tell you about how you can import data in R. We will 
also go over a few commands to manipulate data in R.
```
...
## Read the first sheet of 'your_file.xlsx' into 'df':
...
Now that we have the data in R, let's manipulate the data a bit. The following 
functions might come in handy later on.
