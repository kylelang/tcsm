...
knitr::knit_child(paste0(childDir, "w1_lecture.Rmd"), quiet = TRUE) %>% 
  cat(sep = "\n")
knitr::knit_child(paste0(childDir, "w1_rq.Rmd"), quiet = TRUE) %>% 
  cat(sep = "\n")
knitr::knit_child(paste0(childDir, "w1_home.Rmd"), quiet = TRUE) %>% 
  cat(sep = "\n")
knitr::knit_child(paste0(childDir, "w1_class.Rmd"), quiet = TRUE) %>% 
  cat(sep = "\n")
knitr::knit_child(paste0(childDir, "w1_assess.Rmd"), quiet = TRUE) %>% 
  cat(sep = "\n")
```
